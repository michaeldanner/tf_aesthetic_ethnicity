...
def main():
    ...
    for img in image_generator:
        ...
        if len(detected) > 0:
            ...
            # predict attractiveness and ethnicity of the detected faces
            results = model.predict(faces)
            predicted_asian = results[0]
            attractive = np.arange(0, 101).reshape(101, 1)
            predicted_attractive = results[1].dot(attractive).flatten()
